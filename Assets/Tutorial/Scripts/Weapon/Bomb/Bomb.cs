...
public class Bomb : MonoBehaviour
{
    ...
    public LayerMask explosionHittalbeMask;
    ...
    {
        var overlaps = Physics.OverlapSphere(transform.position, explosionRadius, explosionHittalbeMask, QueryTriggerInteraction.Collide);
